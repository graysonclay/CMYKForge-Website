...
|-----------------------|------------------|----------------------------------------------------|
| `app-build.webp`      | Current App Build | `index.html` + `standard.html` real-progress block |
| `slicer-result.webp`  | Slicer Result     | `index.html` + `standard.html` real-progress block |
| `physical-print.webp` | Physical Print    | `index.html` + `standard.html` real-progress block |
